								...
								<div id="header-search">
									<form class="form-search" role="search" method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>">
										<div class="input-append">
											<input type="text" placeholder="<?php _e('Search', 'largo'); ?>" class="input-medium appendedInputButton search-query" value="" name="s" /><button type="submit" class="search-submit btn" aria-label="<?php esc_attr_e( 'Submit search', 'sfpublicpress' ); ?>"><span class="dashicons dashicons-search"></span></button>
										</div>
									</form>
								</div>
							<?php
